...
<title><s:text name='_my_courses'></s:text></title>
...
<div class="content">
	...
	<div id="myCourse_search">
		<jsp:include page="/WEB-INF/plan/searchPlanCourseContent.jsp"></jsp:include>
	</div>
</div>
...
<script type="text/javascript" src="<%=basePath %>js/plan/myCourse.js"></script>
</html>